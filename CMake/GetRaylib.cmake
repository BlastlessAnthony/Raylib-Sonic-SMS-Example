...
set(SUPPORT_FILEFORMAT_FLAC  ON CACHE BOOL "" FORCE) #Would be nice but OGG and Wave are bettter.
...
add_subdirectory("${DEPENDENCY_DIR}/raylib-${RAYLIB_VER}")
...
if (WIN32)
    ...
    file(GLOB_RECURSE RAYLIB_LIBS "${RAYLIB_BIN_DIR}/*.dll")

    target_link_libraries(${PROJECT_NAME} PRIVATE raylib -lopengl32 -lgdi32 -lwinmm)
...
elseif (LINUX)
    ...
    target_link_libraries(${PROJECT_NAME} PRIVATE raylib -lGL -lm -lpthread -ldl -lrt -lX11)
